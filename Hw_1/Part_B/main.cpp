...
int main() {
    ...
    string georgeHarrisonKey = tree->generateKey();
    addPersonToBST(new Student(georgeHarrisonKey, "George", "Harrison", 4.0), tree);
    ...
    tree->removeValue(georgeHarrisonKey);
    printBST("\nAfter Removing George Harrison", tree);
