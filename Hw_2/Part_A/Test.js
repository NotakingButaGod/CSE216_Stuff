...
//let wentaohe1 = "dsadsasd";
//addPersonToHashTable(new Student("aaa", "George", "Harrison", 4.0), hashTable);
//addPersonToHashTable(new Employee("a1", "Paul", "McCartney", 80000), hashTable);
//hashTable.removeValue("aaa");
...
addPersonToHashTable(new Undergraduate(hashTable.generateKey(), "Jimi", "Hendrix", 3.6, "U1"), hashTable);
